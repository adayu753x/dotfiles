# Generated by Powerlevel10k configuration wizard on 2025-06-03 at 21:11 PDT.
...
function prompt_user_at_host() {
  p10k segment -f 10 -t "%n@%m"
}
 
 typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(user_at_host
    # =========================[ Line #1 ]=========================
